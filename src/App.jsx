      ...
      >
        ...
        <Suspense fallback={null}>
          ...
          {activeWorld !== 'bed' && (() => {
            ...
            if (!cfg) return null
            const labImage = activeWorld === 'desert' ? '/images/lab2.png' : activeWorld === 'snow' ? '/images/lab3.png' : activeWorld === 'jungle' ? '/images/lab4.png' : activeWorld === 'ocean' ? '/images/lab5.png' : activeWorld === 'mushroom' ? '/images/lab6.png' : '/images/lab1.png'
            return (
      ...
      {wallModal && activeWorld !== 'bed' && (
        <div onClick={() => setWallModal(false)} style={{
          ...
          <div onClick={(e) => e.stopPropagation()} style={{
            ...
            <iframe
              src={activeWorld === 'desert' ? '/labs/lab2/html/index.html' : activeWorld === 'snow' ? '/labs/lab3/html/index.html' : activeWorld === 'jungle' ? '/labs/lab4/html/index.html' : activeWorld === 'ocean' ? '/labs/lab5/index.html' : activeWorld === 'mushroom' ? '/labs/lab6/html/index.html' : '/labs/lab1/index.html'}
              style={{
                position: 'relative',
                zIndex: 5,
                width: '100%',
              ...
              title={activeWorld === 'desert' ? 'Лабораторная работа №2' : activeWorld === 'snow' ? 'Лабораторная работа №3' : activeWorld === 'jungle' ? 'Лабораторная работа №4' : activeWorld === 'ocean' ? 'Лабораторная работа №5' : activeWorld === 'mushroom' ? 'Лабораторная работа №6' : 'Лабораторная работа №1'}
            />
          </div>
        </div>
      )}
